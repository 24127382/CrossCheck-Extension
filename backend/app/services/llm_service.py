...
class LLMService:
    """Service for LLM-based operations using Gemini API"""
    ...
    async def summarize(self, claim: str, evidences: List[Evidence]) -> dict:
        ...
        Args:
            ...
            evidences: List of Evidence objects containing source and text
            
        Returns:
            Dictionary with verdict, confidence, and summary
        """
...
"""
    ...
    async def generate_verdict(self, claim: str, evidence_text: str) -> dict:
        ...
        # This method delegates to summarize which returns verdict, confidence, and summary
